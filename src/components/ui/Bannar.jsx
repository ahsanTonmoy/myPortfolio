        ...
        <Box className=" p-4 py-0">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 sectionTitle">
            ...
            >
              ...
              <div className=" uppercase md:text-[50px] text-4xl tracking-widest bg-gradient-to-r from-[#7636f8] to-white inline-block text-transparent bg-clip-text font-bold leading-tight">
                full stack (mern) <br /> web developer
              </div>
              ...
              <div className="grid lg:grid-cols-2 gap-4 justify-items-center lg:justify-items-start">
                ...
                <Link
                  href={
                    "https://drive.google.com/file/d/1F5Yc6C4yVOnA_ps691hNneoEYYXG08sQ/view?usp=drive_link"
                  }
                  target="_blank"
                >
                  <Button
                    className="text-[#8750f7] text-base border-[#8750f7] hover:border-[#8750f7] w-full rounded-full font-bold px-12"
                    variant="outlined"
                ...
                <Box className="social-icon flex gap-4 flex-wrap justify-center">
                  ...
                  <Link
                    href={
                      "https://www.facebook.com/profile.php?id=100010579990810"
                    }
                  >

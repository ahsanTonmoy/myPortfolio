        ...
        <Container className="grid grid-cols-1 lg:grid-cols-2 gap-8">
              ...
              <form>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div className=" col-span-2 md:col-span-1">
                    <input
                      className="p-3 border border-[#8750f7] bg-black rounded capitalize w-full"
                      type="text"
                ...
                <input
                  className="hover:bg-gradient-to-l bg-gradient-to-r from-[#6c3ccb] to-[#2a1454] p-4 w-full rounded-lg font-bold capitalize cursor-pointer my-4"
                  type="submit"
                  value="send message"
                />
              </form>
          ...
          <Box className="grid place-content-center gap-6">
            ...
            <div className="flex gap-4">
              {/* icon */}
              <div className="text-white text-3xl w-12 h-12 p-2 rounded-full bg-gradient-to-t from-[#6c3ccb] to-[#2a1454]">
